...
export async function pushDigest(cfg) {
  ...
  // Pre-compute summaries in parallel batches so 100+ item digests
  // don't serialize behind LLM latency. Each item gets `_summary`
  // when digest.enable_summary is true.
